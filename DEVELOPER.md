...
**v0.4.3-alpha.1 — Pure Modular Architecture**
...
├── version.py                     # Single source of truth for version (v0.4.3-alpha.1)
...
|---|---|
| [`build_installer.py`](file:///c:/GIT-Projects/A.U.R.A-eve-tool/A.U.R.A.%20Source/tools/build_installer.py) | Compiles the single-executable setup wizard (`AURA_Setup_v0.4.3-alpha.1.exe`) via PyInstaller, embedding the installer GUI, manifests, and extraction engine. |
