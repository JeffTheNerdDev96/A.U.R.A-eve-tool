...
**v0.3.0-alpha1** — local, unofficial EVE Online companion. Intel, D-scan matchup, a stargate bubble map, and an onboard chat assistant. No cloud telemetry.
...
Standalone: `AURA_Setup_v0.3.0-alpha1.exe` (bundled Python 3.12 and model weights).
