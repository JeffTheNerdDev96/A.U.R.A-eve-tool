...
* **Setup**: Double-click `install_intel_npu.bat`
...
* **Setup**: Double-click `install_amd_npu.bat`
...
* **Setup**: Double-click `install_nvidia_cuda.bat`
...
* **Setup**: Double-click `install_amd_vulkan.bat`
...
* **Setup**: Double-click `install_cpu.bat`
