...
echo ===================================================================
echo [!] Installing OpenVINO & Core PyQt6 for Intel AI Boost NPU & Arc GPUs...
echo.
...
"%PYTHON_EXE%" -m pip install --prefer-binary --extra-index-url https://abetlen.github.io/llama-cpp-python/whl/cpu -r "%SCRIPT_DIR%requirements-intel-npu.txt"

echo.
echo [OK] Intel NPU/GPU OpenVINO setup complete! Launch run.bat to start A.U.R.A.
pause
