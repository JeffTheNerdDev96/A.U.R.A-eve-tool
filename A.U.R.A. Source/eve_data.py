...
SHIP_DATABASE: Dict[str, Dict[str, Any]] = {
    ...
    "Heretic": {
            ...
            "turret_hardpoints": 2,
            "launcher_hardpoints": 2,
            "weapon_type": "Small Energy Lasers / Rockets + Warp Interdiction Bubbles",
            "bonuses": [
                    "Armor Warp Bubble Launcher"
            ],
            "pre_rendered_dossier": "\u2022 Vessel: Heretic [Interdictor | Amarr]\n  - Combat Role: Armor Warp Bubble Launcher\n  - Weapon System: Small Energy Lasers / Rockets + Warp Interdiction Bubbles\n  - Slot Layout: Highs: 4 | Mids: 4 | Lows: 4 | Rigs: 3 (Turrets: 2 | Launchers: 2)\n  - Key Bonuses: Armor Warp Bubble Launcher\n  - Defense Profile: Armor Buffer | Speed: Fast (2.8+ km/s)\n  - Weapon Optimal: 0-20 km\n  - Tactical Counter-Play: Deploys 20km warp disruption bubbles on gates."
    },
    "Pontifex": {
            "class": "Command Destroyer",
            "faction": "Amarr",
    ...
    "Hurricane Fleet Issue": {
            ...
            "pre_rendered_dossier": "\u2022 Vessel: Hurricane Fleet Issue [Faction Battlecruiser | Minmatar (Fleet)]\n  - Combat Role: High Alpha Projectile / Armor Fleet BC\n  - Weapon System: Medium Projectile (425mm Autocannons / 720mm Artillery)\n  - Slot Layout: Highs: 8 | Mids: 4 | Lows: 6 | Rigs: 3 (Turrets: 6 | Launchers: 2)\n  - Key Bonuses: 5% Medium Projectile damage per lvl | 5% Medium Projectile tracking per lvl | 5% rate of fire\n  - Defense Profile: Armor Buffer / Shield | Speed: Fast\n  - Weapon Optimal: 15-35 km (AC) / 45-80 km (Art)\n  - Tactical Counter-Play: Devastating projectile alpha. Apply Tracking Disruptors and high transversal."
    },
    "Cyclone Fleet Issue": {
            "class": "Faction Battlecruiser",
            "faction": "Minmatar (Fleet)",
            ...
            "pre_rendered_dossier": "\u2022 Vessel: Cyclone Fleet Issue [Faction Battlecruiser | Minmatar (Fleet)]\n  - Combat Role: Rapid Missile / Active Shield Brawler\n  - Weapon System: Heavy Assault Missiles (HAM) / Heavy Missiles (RLML)\n  - Slot Layout: Highs: 7 | Mids: 5 | Lows: 5 | Rigs: 3 (Turrets: 2 | Launchers: 5)\n  - Key Bonuses: 5% missile rate of fire per lvl | 7.5% missile velocity | 7.5% shield boost amount\n  - Defense Profile: Active Shield Boost | Speed: Fast\n  - Weapon Optimal: 20-55 km\n  - Tactical Counter-Play: Heavy missile DPS with active shield repair. Apply Missile Guidance Disruptors and Neuts."
    },
    "Stabber Fleet Issue": {
            "class": "Faction Cruiser",
            "faction": "Minmatar (Fleet)",
            ...
            "pre_rendered_dossier": "\u2022 Vessel: Stabber Fleet Issue [Faction Cruiser | Minmatar (Fleet)]\n  - Combat Role: Fast Projectile Fleet Cruiser\n  - Weapon System: Medium Projectile (220mm-425mm Autocannons / 720mm Artillery)\n  - Slot Layout: Highs: 6 | Mids: 4 | Lows: 6 | Rigs: 3 (Turrets: 5 | Launchers: 3)\n  - Key Bonuses: 10% Medium Projectile damage per lvl | 7.5% tracking | 5% falloff\n  - Defense Profile: Shield Buffer / Armor | Speed: Very Fast\n  - Weapon Optimal: 10-25 km (AC) / 35-65 km (Art)\n  - Tactical Counter-Play: High speed projectile kiter/brawler. Apply Tracking Disruptors and webs."
    },
    "Scythe Fleet Issue": {
            "class": "Faction Cruiser",
            "faction": "Minmatar (Fleet)",
            ...
            "pre_rendered_dossier": "\u2022 Vessel: Scythe Fleet Issue [Faction Cruiser | Minmatar (Fleet)]\n  - Combat Role: High-Speed Missile / Turret Attack Cruiser\n  - Weapon System: Heavy Assault Missiles (HAM) / Rapid Light Missiles (RLML) or 425mm Autocannons\n  - Slot Layout: Highs: 5 | Mids: 5 | Lows: 5 | Rigs: 3 (Turrets: 4 | Launchers: 4)\n  - Key Bonuses: 10% missile damage per lvl | 10% projectile damage | 5% velocity\n  - Defense Profile: Shield Buffer | Speed: Extreme\n  - Weapon Optimal: 20-60 km\n  - Tactical Counter-Play: Blistering speed missile/turret cruiser. Tackle with Warp Scrambler to kill MWD speed."
    },
    "Thrasher Fleet Issue": {
            ...
            "pre_rendered_dossier": "\u2022 Vessel: Thrasher Fleet Issue [Faction Destroyer | Minmatar (Fleet)]\n  - Combat Role: High Alpha Artillery / Autocannon Destroyer\n  - Weapon System: Small Projectile (200mm Autocannons / 280mm Artillery)\n  - Slot Layout: Highs: 8 | Mids: 3 | Lows: 4 | Rigs: 3 (Turrets: 7 | Launchers: 1)\n  - Key Bonuses: 10% Small Projectile damage per lvl | 10% tracking | 5% sig radius reduction\n  - Defense Profile: Shield / Armor Buffer | Speed: Very Fast\n  - Weapon Optimal: 0-15 km (AC) / 25-50 km (Art)\n  - Tactical Counter-Play: Extreme 7-gun projectile alpha. Apply Tracking Disruptors and close-range scram/web."
    },
    "Algos Navy Issue": {
            "class": "Faction Destroyer",
            "faction": "Gallente (Navy)",
    ...
    "Nergal": {
            ...
            "pre_rendered_dossier": "\u2022 Vessel: Nergal [Assault Frigate | Triglavian Collective]\n  - Combat Role: Spooling Assault Frigate\n  - Weapon System: Small Entropic Disintegrator (Spooling Precursor)\n  - Slot Layout: Highs: 3 | Mids: 3 | Lows: 4 | Rigs: 2 (Turrets: 1 | Launchers: 0)\n  - Key Bonuses: 100% max damage spool | 5% damage per lvl | 7.5% Armor Rep | ADC Capable\n  - Defense Profile: Active Armor + ADC | Speed: Fast\n  - Weapon Optimal: 5-22 km\n  - Tactical Counter-Play: Spooling disintegrator deals extreme single-target DPS over time. Apply Tracking Disruptors or damp lock to reset spool."
    },
    "Vendetta": {
            "class": "Supercarrier",
            "faction": "Serpentis",
            ...
            "pre_rendered_dossier": "\u2022 Vessel: Vendetta [Supercarrier | Serpentis]\n  - Combat Role: Pirate Supercarrier / Heavy Web Stasis\n  - Weapon System: Capital Heavy Fighters & Capital Hybrid Blasters (90% Stasis Web)\n  - Slot Layout: Highs: 6 | Mids: 8 | Lows: 8 | Rigs: 3 (Turrets: 0 | Launchers: 0)\n  - Key Bonuses: 90% Stasis Webifier strength | 10% Heavy Fighter damage | 4% Armor resists\n  - Defense Profile: Heavy Armor Buffer | Speed: Fast for Super\n  - Weapon Optimal: Omni Capital Grid\n  - Tactical Counter-Play: Extreme capital web and fighter threat. Counter with sub-capital evasion and dreadnought siege focus."
    },
    "Primae": {
            "class": "Industrial",
...
_COMMON_STOP_WORDS = {
    ...
    # Module & faction words that should never match standalone ships
    "burst", "republic", "imperial", "caldari", "gallente", "amarr", "minmatar", "federation",
    "standard", "heavy", "light", "medium", "small", "large", "covert", "assault",
    "fleet", "combat", "pulse", "beam", "aerator", "collision", "accelerator",
    "damage", "control", "ancillary", "repairer", "afterburner", "scrambler", "howitzer",
    "autocannon", "artillery", "booster", "battery", "extender", "plate", "plates", "rig", "rigs"
}

_SHIP_SLANG_MAP: Dict[str, str] = {
    "abaddon": "Abaddon",
    "algos ni": "Algos Navy Issue",
    "ani": "Apocalypse Navy Issue",
    "apoc": "Apocalypse",
    "apoc ni": "Apocalypse Navy Issue",
    "apocalypse ni": "Apocalypse Navy Issue",
    "arazu": "Arazu",
    "armageddon ni": "Armageddon Navy Issue",
    "ashimmu": "Ashimmu",
    "astero": "Astero",
    "avalanche": "Avalanche",
    "baddon": "Abaddon",
    ...
    "domi": "Dominix",
    "domi ni": "Dominix Navy Issue",
    "dominix ni": "Dominix Navy Issue",
    "drake": "Drake",
    "dram": "Dramiel",
    "dramiel": "Dramiel",
    "drek": "Drekavac",
    ...
    "garmur": "Garmur",
    "geddon": "Armageddon",
    "geddon ni": "Armageddon Navy Issue",
    "gila": "Gila",
    "gole": "Golem",
    "golem": "Golem",
    "heretic": "Heretic",
    ...
    "huginn": "Huginn",
    "hulk": "Hulk",
    "hurricane fi": "Hurricane Fleet Issue",
    "hyp": "Hyperion",
    "hype": "Hyperion",
    "hyperion": "Hyperion",
    "iki": "Ikitursa",
    ...
    "maller": "Maller",
    "mega": "Megathron",
    "mega ni": "Megathron Navy Issue",
    "megathron ni": "Megathron Navy Issue",
    ...
    "scimi": "Scimitar",
    "scorp": "Scorpion",
    "scorp ni": "Scorpion Navy Issue",
    "scythe fi": "Scythe Fleet Issue",
    ...
    "stabber": "Stabber",
    "stabber fi": "Stabber Fleet Issue",
    "strat": "Stratios",
    "stratios": "Stratios",
    "succ": "Succubus",
    "succubus": "Succubus",
    "talos": "Talos",
    "tempest": "Tempest",
    "tempest fi": "Tempest Fleet Issue",
    "tengu": "Tengu",
    "tfi": "Tempest Fleet Issue",
    "thorax": "Thorax",
    "thrasher fi": "Thrasher Fleet Issue",
    "tornado": "Tornado",
    "tyfi": "Typhoon Fleet Issue",
    "typhoon": "Typhoon",
    "typhoon fi": "Typhoon Fleet Issue",
    "vaga": "Vagabond",
    "varg": "Vargur",
    "vargur": "Vargur",
    "vedmak": "Vedmak",
...
def get_tactical_summary_for_text(text: str, attachments: Any = None, piloted_ship: Optional[str] = None, piloted_ship_name: Optional[str] = None) -> str:
    ...
    def _format_dossier(ship_name: str, s_info: dict) -> str:
        cls = s_info.get('class', 'Vessel')
        fac = s_info.get('faction', 'Faction')
        role = s_info.get('role', 'Combat Vessel')
        wp = s_info.get('weapon_type', 'Standard Weapons')
        tank = s_info.get('tank', 'Combat Tank')
        tactics = s_info.get('tactics', 'Standard tactical engagement.')
        
        if not is_combat_context:
            return f"• Vessel Dossier: {ship_name} [{cls} | {fac}] — Role: {role} | Authentic Weapons: {wp} | Tank: {tank} | Flight Profile: {tactics}"
        
        wp_lower = wp.lower()
        is_missile = any(k in wp_lower for k in ['missile', 'torpedo', 'rocket', 'ham', 'rlml']) and not any(k in wp_lower for k in ['autocannon', 'artillery', 'blaster', 'railgun', 'laser', 'projectile', 'disintegrator', 'vortron'])
        is_turret = any(k in wp_lower for k in ['projectile', 'autocannon', 'artillery', 'laser', 'hybrid', 'blaster', 'railgun', 'disintegrator', 'vortron'])
        
        if is_turret and is_missile:
            counter = "Tracking Disruptors (vs Turrets) or Missile Guidance Disruptors (vs Missiles)"
        elif is_turret:
            counter = "Tracking Disruptors (Tracking/Optimal scripts) & High Transversal (Turret Hull)"
        elif is_missile:
            counter = "Missile Guidance Disruptors (Range/Velocity scripts) & Sig Radius control (Missile Hull)"
        elif "interdictor" in role.lower() or "bubble" in wp_lower:
            counter = "Pre-align & Warp Scrambler (MWD shutoff) to neutralize bubble trap"
        else:
            counter = "Warp Scrambler / Webifier & High Transversal"
            
        return f"• Hostile Target Dossier: {ship_name} [{cls} | {fac}] — Role: {role} | Authentic Weapons: {wp} | Tank: {tank} | Verified Counters: {counter}"
    ...
    for ship_name, s_info, ship_lower in _MULTI_WORD_SHIPS:
        if ship_lower in lower_text:
            ...
            if ship_lower not in detected_hulls and len(detected_hulls) < 3:
                ...
                grounding_blocks.append(_format_dossier(ship_name, s_info))
    ...
    for w in words:
        ...
        if s_info:
            ...
            if cname_l not in detected_hulls:
                ...
                grounding_blocks.append(_format_dossier(cname, s_info))
