...
title Adaptive Underworld Recon Array (A.U.R.A.) - v0.2.1-alpha2

cls
echo ===================================================================
echo   [+] Adaptive Underworld Recon Array (A.U.R.A.) - v0.2.1-alpha2
echo   Angel Cartel Cybernetics Division
echo ===================================================================
echo.

if exist "%SCRIPT_DIR%A.U.R.A.-v0.2.1-alpha2.exe" (
    start "" /d "%SCRIPT_DIR%" "%SCRIPT_DIR%A.U.R.A.-v0.2.1-alpha2.exe"
    exit /b 0
)
...
echo [X] Python 3.12+ was not found. Run AURA_Setup_v0.2.1-alpha2.exe or requirements\install_auto.bat
pause
exit /b 1
