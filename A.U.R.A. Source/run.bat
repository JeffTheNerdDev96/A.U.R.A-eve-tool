...
title Adaptive Underworld Recon Array (A.U.R.A.) - v0.5.1-alpha.1

cls
echo ===================================================================
echo   [+] Adaptive Underworld Recon Array (A.U.R.A.) - v0.5.1-alpha.1
echo   Angel Cartel Cybernetics Division
echo ===================================================================
echo.

if exist "%SCRIPT_DIR%A.U.R.A.-v0.5.1-alpha.1.exe" (
    start "" /d "%SCRIPT_DIR%" "%SCRIPT_DIR%A.U.R.A.-v0.5.1-alpha.1.exe"
    exit /b 0
)
...
echo [X] Python 3.12+ was not found. Run AURA_Setup_v0.5.1-alpha.1.exe or requirements\install_auto.bat
pause
exit /b 1
